...
<body>
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
						...
						<li class="active"><a href="./showbooks.jsp">Search Books</a></li>
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row">
				<h3 class="page-header">Search Books</h3>
				
				<form method="get" action='searchbooks' class="center col-md-3">
					 <div class="form-group">
					 <label for="criteria">Search Criteria</label>
					<select name="criteria" class="form-control">
						<option value="author">Author Name</option>
						<option value="book">Book Name</option>
						<option value="publisher">Publiser Name</option>
					</select> 
					</div>
					<div class="form-group">
				...
				<h2 class="sub-header">Books Available</h2>
						...
						<tbody>
							<c:forEach items="${books}" var="book">
								<tr>
									...
									<td><c:out value="${book.bookEdition}" /></td>
									<td><c:out value="${book.floor}" /></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
	...
	<div id="global-zeroclipboard-html-bridge"
		...
		<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
			...
			<param name="movie"
				value="/assets/flash/ZeroClipboard.swf?noCache=1417404961452">
			...
			<embed src="/assets/flash/ZeroClipboard.swf?noCache=1417404961452"
